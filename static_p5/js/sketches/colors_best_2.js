var e,r,e2,r2,g1,g2,s,ging,movers
...
function setup() {
  ...
  for (let i = 0;i<500;i++){
    ...
    var p = pointOnGround(ging, random(-30,30),random(5000))
    var r = new Rect3D(p[1],random(100),random(100))
    r.rotate(radians(90),'x')
    r.rotate(radians(40),'z')
    r.translate(createVector(0,0,Math.abs(randomGaussian(0,400))))
    var m = new Mover3D(p[1],20)
    movers.push(m)
    shapes.push(r)
  }
