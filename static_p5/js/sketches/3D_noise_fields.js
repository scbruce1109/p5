...
function setup() {
  ...
  createCanvas(600, 600);
   ...
   var linep = [
     createVector(200,200,0),
     createVector(0,10000,0),

   ]
   r = new Rect3D(createVector(0,0,0),100,100)
r.rotate(radians(45),'z')
   // r.rotate(radians(45),'z')

   console.log(r.rotation)

   l = new Line3D(linep)
   m = new Mover3D(createVector(0,0,0),2,new Sphere3D(createVector(0,0,0),4,4))
   m.mass = 100
   m2 = new Mover3D(createVector(-500,0,0),10,new Sphere3D(createVector(-500,0,0),2,2),createVector(100,0,100))
   console.log(m2.velocity)
...
// var ccc3 = pal[1]
  ...
  // g.fillColor(colors,randomPoints(width,height,4),300,color(255))
  ...
  //   var m = new Mover1(random(width),random(height),1,1);
  //   movers.push(m)
  // }
...
ging.displayHL();
  // l.display(ging)
  // m.display(ging)
  // m2.addForce(createVector(0,1,0))

  // m2.addForce(m.attract(m2))
  // m2.display(ging)
  //
  // m.addForce(m2.attract(m))
  // m.display(ging)
