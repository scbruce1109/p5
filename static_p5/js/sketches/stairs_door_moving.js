...
function setup() {
  ...
  var p2 = pointOnGround(ging, random(-30,30),random(10000,10000))
...
var ps = [p3[1],p2[1]];
  ...
  console.log(pPoints)
  g1.fillColor([color("#1b2821"),color("#3d5b30"),color('#59733c'),color('#335933'),color('#ffe700')],pPoints,600,color('#ffffff'))
  // g1.display();
