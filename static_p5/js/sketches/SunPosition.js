...
var s,shapes,l,m, m2,m3,movers,w,e,r, e2
var g,g2,t;
var earth;
...
function setup() {
  ...
  e = new Ellipse3D(createVector(0,0,0),1000,1000,100)
  // e = new Box3D(createVector(0,0,0),100,100,100);
  var datePoint = placePoint3D(createVector(0,0,0),0,coord[0]%360+90,1000);
  earth = new Sphere3D(datePoint,20)
  // earth = new Rect3D(datePoint,20,20)
  earth.rotate(radians(23.439),'x',createVector(0,0,0))
  r = new Rect3D(createVector(0,0,0),100,100)
  e2 = new Ellipse3D(createVector(0,0,0),1000,1000,100)
  e2.rotate(radians(23.439),'x')
  r.rotate(PI/2,'x')
  t = 10000
