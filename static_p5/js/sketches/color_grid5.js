...
params.points = [createVector(random(width),random(width)),createVector(random(width),random(width)),createVector(random(width),random(width))]

console.log(params.points)
params.points[0].mass = 2
...
// params.points = distributePointsOnLine(createVector(random(width),random(height)), createVector(random(width),random(height)), 4)
  ...
  g1.fillColor([color("#ff7a40"),color("#ffe040"),color("#00016b")],params.points,300,color('#ffffff'))
  g1.display()
